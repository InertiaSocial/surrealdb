...
#[cfg(feature = "wasm")]
const ARGUMENTS: &str =
	"The WASM module function can take various argument types, depending on the function exported.";
...
impl Wasm {
	...
	pub(crate) async fn compute(
		...
		crate::wasm::execution::execute_wasm_function(&bytes, &self.func.to_string(), &self.args)
			.await
